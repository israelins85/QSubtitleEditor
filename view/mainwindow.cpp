    ...
    ui(new Ui::MainWindow)
{
    ...
    m_mediaPlayer->setVideoOutput(ui->wdgVideo->surface());

    connect(m_mediaPlayer, &QMediaPlayer::durationChanged, ui->sliProgress, [this](qint64 a_duration) {
        ui->sliProgress->setMaximum(int(a_duration / 1000));
